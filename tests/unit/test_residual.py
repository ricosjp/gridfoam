"""
Residual helpers distinguish exact solutions, mismatches, and either
tolerance hit.
"""
...
def test_continuity_residual_is_nonnegative(
    small_axis_projected_grid: AxisProjectedGrid,
) -> None:
...
def test_residual_satisfied_absolute_or_relative() -> None:
    """
    Either absolute or relative tolerance suffices; missing both fails
    convergence.
    """
